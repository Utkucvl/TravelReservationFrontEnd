...
const HotelReservationAdminHotelDetailsComp = ({ hotel, visible, onClose, loading }) => {
  return (
    <Modal
      title="Hotel Details"
      visible={visible}
...
HotelReservationAdminHotelDetailsComp.propTypes = {
...
export default HotelReservationAdminHotelDetailsComp;
