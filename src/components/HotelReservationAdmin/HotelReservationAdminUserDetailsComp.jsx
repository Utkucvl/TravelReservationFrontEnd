...
const HotelReservationAdminUserDetailsComp = ({ user, visible, onClose,loading2 }) => {
...
HotelReservationAdminUserDetailsComp.propTypes = {
...
export default HotelReservationAdminUserDetailsComp;
