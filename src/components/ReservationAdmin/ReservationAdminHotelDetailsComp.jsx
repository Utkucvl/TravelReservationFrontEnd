...
const ReservationAdminHotelDetailsComp = ({ hotel, visible, onClose, loading }) => {
  return (
    <Modal
      title="Hotel Details"
      visible={visible}
...
ReservationAdminHotelDetailsComp.propTypes = {
...
export default ReservationAdminHotelDetailsComp;
