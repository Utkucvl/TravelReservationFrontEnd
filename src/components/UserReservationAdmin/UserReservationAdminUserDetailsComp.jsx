...
const UserReservationAdminUserDetailsComp = ({ user, visible, onClose,loading2 }) => {
...
UserReservationAdminUserDetailsComp.propTypes = {
...
export default UserReservationAdminUserDetailsComp;
